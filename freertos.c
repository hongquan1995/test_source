...
/**
  ...
  * @attention
  *
  * <h2><center>&copy; Copyright (c) 2022 XHSC.
...
uint8_t Step_test_u8 = 0;
/* USER CODE END Variables */
osThreadId TaskFTPHandle;
osThreadId TaskControlSimHandle;
osThreadId TaskUartSimHandle;
osThreadId LoRaProcessTaskHandle;
osThreadId LoRaResponseTasHandle;
osThreadId motorTaskHandle;
osThreadId con1TaskHandle;
osThreadId con2TaskHandle;
osThreadId con3TaskHandle;
osThreadId con4TaskHandle;
osThreadId ComunicationTasHandle;
osMessageQId qLora_SimHandle;
osMessageQId qSIM_SIM_UpdateHandle;
